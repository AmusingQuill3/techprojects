...
int main(int argc, char** argv) {
	...
	cout << "Elijah Bixby -- CSIS 215 Programming Assignment 1 -- Bag Dictionary" << endl << endl;
	...
	cout << endl << "Bag size before adding: " << myBag.size();
	//Testing += operator
	KVpair<int, string> Name(10, "Hello");
	myBag += Name;

	cout << endl << "Bag size after adding: " << myBag.size() << endl;
